...
HTTP_URL_CLIP_vision_MODELS=(
    "https://huggingface.co/h94/IP-Adapter/resolve/main/models/image_encoder/model.safetensors?download=true,CLIP-ViT-H-14-laion2B-s32B-b79K.safetensors"
)
